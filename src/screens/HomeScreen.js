      ...
      <div className='homeScreen__featured' >
        <Fade>
          <Featured
            ...
            info='Say yes to sips of delight with our Honey Almondmilk Flat White
        ...
        <Fade>
          <Featured
            title='PISTACHIOOOOOO'
            info='Embrace creamy coffee bliss with our new Pistachio Latte and
                  Pistachio'
      ...
      <Fade>
        <div className='homeScreen__discover' >
          <Info 
            ...
            info="Just open the app, order your favorite, and enjoy contactless pay.
          ...
          <Info 
            ...
            info="Make everything a little brighter. Enjoy a $0 Delivery Fee on your
                  first Uber Eats order over $15"
            link="Order now"
            color="#1e3932"
            background="#d4e9e4"
            className="info__hoverLight"
